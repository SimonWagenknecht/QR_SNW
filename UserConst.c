...
const char DMmod1[16]								= {"SLAVE 1: WPU   "};	// ***AnFre 19.04.2012 DatenManager 06.06.2012 HeizKreisVerteiler
const char DMmod2[16]								= {"SLAVE 2: FW    "};	// ***AnFre 19.04.2012 DatenManager	06.06.2012 Wärmepumpe
...
const char Hkmod_SoL[16]						= {"Solare Einsp.  "};	//***AnFre
...
const char Diamod[16]								= {"DIAG           "};	//***AnFre WZ1,WZ3, TH2, TN2  24.09.2014
...
const char c_Mode_S3                = MASTER;            // NULL_MODE = dummy,  MASTER, SLAVE
const UINT c_Baudrate_S3            = 9600;                    // 0         = dummy
const char c_Funktion_S3            = MBUS1_FU;              // NULL_FU   = dummy,  GBUS_FU, MODBUS1_FU, MBUS1_FU, GENI1_FU...siehe projdef.h
...
const Anlage Projekte[] = {
	...
	{	
	 ...
	 //"??-R-????-?????"			//Kennzeichen an fester Position !!	
		...
		// Steuercode für MBUS
		{1,1,1},	// Nummern der Kaltstartparametersätze für jeden MBUS-Zähler[MB_PROFILE]
							// 0 = nicht vorhanden
...
const Anl37 R37_Beleg[] = {
	...
	{	
		STWHK4,		// HK2: Sicherheitstemp.w. STW HK			// Digital-Eingang DE1  
		...
		TMANF1,		// ANL: Sollw.-Anf.										// Analog-Ausgang  AA1
		RVENT3,		// HK1: Regelv. Heizk.1		 RV HK1 		// Analog-Ausgang  AA2
		AA_FREI,	// 			FREI													// Analog-Ausgang  AA3
		RVENT4,		// HK2:	Regelv. Heizk.2		 RV HK2			// Analog-Ausgang  AA4
	...
	{	
		...
		BM_UNI1,	// QRG: BM PU Quellenk.		 BM PU QRG	// Digital-Eingang DE4 
		BM_UNI2,	// WEI: BM PU Weichenk.		 BM PU WEI	// Digital-Eingang DE5 
...
// R36-E2
	...
	{2,				6,			0,			1,		0,			0,			6,			{0,1,1},	 {0},			"NAHWAERMENETZ  ", "               "},// ZIN8		// 1 Impuls =   10 l  (0,01m³)
	{3,				6,			0,			0,		0,			0,			7,			{0,1,1},	 {0},			"SOLAR-EINTRAG  ", "               "},// ZIN9		// 1 Impuls =    1 l  (0,001m³)
	{2,				6,			0,			1,		0,			0,			8,			{0,1,1},	 {0},			"QUELLENREGEN.  ", "               "},// ZIN10	// 1 Impuls =   10 l  (0,01m³)
// R37_1
