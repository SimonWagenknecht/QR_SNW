// Diese Datei wurde automatisch am : 10.03.2015 um 14:15:48 generiert und entspricht der Systemversion nach 04.09.2012 13:47:53!!!
// Path: D:\RIEcon36C\Projekte\Parabel\JMX_2015\KER1s03_JMX51\KER1s03_JMX51\Komtabparser.exe
...
const Pgrup so1[] = { 
	...
	{" 25;"," LADU.EIN RV-HKS"," %     ", P&sos[SO1].RvHksStart,		US_INT, 1, P&hid1,	V0, 0, 0},
	{" 26;"," LADU.AUS RV-HKS"," %     ", P&sos[SO1].RvHksEnde,			US_INT, 1, P&hid1,	V0, 0, 0},
	{" 27;"," LADU.EIN PU-HK1"," %     ", P&sos[SO1].PumStart,			US_INT, 1, P&hid1,	V0, 0, 0},
	{" 28;"," LADU.AUS PU-HK1"," %     ", P&sos[SO1].PumEnde,				US_INT, 1, P&hid1,	V0, 0, 0},
	...
	{" 37;"," SOL-PU REG.-ART"," 0..3  ", P&BusPuPara[PU_BUS_SOL - 1].Regelart,	US_CHAR,  0, P&wilo1,	V1, 0, IDX0_FELD},
	{" 38;"," PUF-PU SOLLWERT"," %     ", P&sos[SO1].BusPufPuSoll,	US_INT, 1, P&wilo2,	V1, 0, 0},
	{" 39;"," PUF-PU REG.-ART"," 0..3  ", P&BusPuPara[PU_BUS_PUF - 1].Regelart,	US_CHAR,  0, P&wilo2,	V1, 0, IDX0_FELD},
	...
	{"*84:"," TEMP SOL-PUMPE?","       ", P&pusoTempAl,					JANEIN_FORM, 0, P&vis,	V1, 0, 0},
	...
	{" ->;"," SOL-PU REGELART"," 0..3  ", P&BusPuPara[PU_BUS_SOL-1].RegelartHand,	US_CHAR, 0, P&wilo1,	V1, 0, IDX0_FELD},
	...
	{" ->;"," PUF-PU REGELART"," 0..3  ", P&BusPuPara[PU_BUS_PUF-1].RegelartHand,	US_CHAR, 0, P&wilo2,	V1, 0, IDX0_FELD},
	{" ->;"," PUF-PU SOLLWERT"," %     ", P&BusPuPara[PU_BUS_PUF-1].SollHand, 		US_INT,  1, P&wilo2,	V1, 0, IDX0_FELD},
...
const Pgrup wlp[] = { 
	...
	{" 00;"," PUMPEN-INDEX   "," # 1-8 ", P&SerialDeviceNr,										 EXPAND_CHAR,  0, P&hid1,	V1, 0, 0},
	...
	{" 71."," bus-timeout    ","       ", P&modb_control[0].bus_timeout, 		 				US_CHAR, 0, P&hid2,	V0, 0, EXP_WLP},
	{"*72."," exception?     ","       ", P&modb_control[0].exeption_code, 	 EXEPTION_FORM,  0, P&hid2,	V0, 0, EXP_WLP},
	{"*73."," tx-error-status","       ", P&modb_control[0].tx_errorflag, 	BUS_ERROR_FORM,  0, P&hid2,	V0, 0, EXP_WLP},
	{"*74."," rx-error-status","       ", P&modb_control[0].rx_errorflag, 		 		 US_CHAR,  0, P&hid2,	V0, 0, EXP_WLP},
	{"*75."," rx-error-count ","       ", P&modb_control[0].error_count, 		 			 US_CHAR,  0, P&hid2,	V0, 0, EXP_WLP},
...
const Pgrup sys[] = { 
	...
	{"*88;"," SD-ARCHIV-STAT.","       ", P&a_ret_text,		  ASCII_FORM, 0, P&hid1,	V0, 0, 0},
	{"_->;"," SD-LAST-ERROR  ","       ", P&last_err_text,		ASCII_FORM, 0, P&hid1,	V0, 0, 0},
...
const Pgrup hk1[] = { 
	...
	{"*03:"," SPEICHER OB.TH3"," C    ", P&TW2_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*03:"," SPEICHER OB.TH3","       ", P&TW2_[0],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	{"*04:"," SPEICHER MI.TH4"," C    ", P&TW3_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*04:"," SPEICHER MI.TH4","       ", P&TW3_[0],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	{"*05:"," SPEICHER UN.TH5"," C    ", P&TW4_[0],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*05:"," SPEICHER UN.TH5","       ", P&TW4_[0],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	...
	{" 50;"," L-PUM SOLL MIN "," %     ", P&hks[HK1].PuDzMin,				US_INT, 1, P&hid1,	V1, 0, 0},
	{" 51;"," Ta L-PU.SOLL MI"," C    ", P&hks[HK1].PuDzTaMax,		 	 S_INT, 1, P&hid1,	V1, 0, 0},
	{" 52;"," L-PUM SOLL MAX "," %     ", P&hks[HK1].PuDzMax,				US_INT, 1, P&hid1,	V1, 0, 0},
	{" 53;"," Ta L-PU.SOLL MA"," C    ", P&hks[HK1].PuDzTaMin,		 	 S_INT, 1, P&hid1,	V1, 0, 0},
	...
	{" 66;"," ABSENKUNG SOLAR"," K     ", P&hks[HK1].AbsenkSol,			US_INT, 1, P&hid1,	V2, 0, 0},
	{" 67;"," FAKTOR ABSENK. ","       ", P&hks[HK1].AbsenkFaktor,	US_INT, 2, P&hid1,	V2, 0, 0},
	...
	{"*73:"," LADE-PUMPE EIN?","       ", P&hkd[HK1].puEinAnz, JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*->:"," BM LADE-PU EIN?","       ", P&hkd[HK1].puBmAnz,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*88:"," SM LADE-PUMPE ?","       ", P&hkd[HK1].puSmAnz,	 JANEIN_FORM, 0, P&vis,		E1, STANDARD, 0},
	...
	{" ->;"," PUMPE REGELART "," 0..3  ", P&BusPuPara[PU_BUS_HK1-1].RegelartHand,	US_CHAR, 0, P&wilo3,	V1, 0, IDX0_FELD},
	{" ->;"," PUMPE SOLLWERT "," %     ", P&hks[HK1].PuDzHand,		  US_INT, 1, P&hid1,	V1, 0, 0},
...
const Pgrup hkSoL[] = { 
	...
	{" 33;"," SOL.LAD. TH3MAX"," C    ", P&hksSoL[HK1].TH3Max,							US_INT, 1, P&hid1,	V0,	0, 0},
...
const Pgrup hk2[] = { 
	...
	{"*01:"," VORL. NETZ  TN1"," C    ", P&TVS[HK2],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*01:"," VORL. NETZ  TN1"," C    ", P&TVS[HK2],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	{"*02:"," RUECKL.NETZ TN2"," C    ", P&TRS[HK2],						 ANA_FORMP, 1, P&vis,		V1, 0, 0},
	{"*02:"," RUECKL.NETZ TN2"," C    ", P&TRS[HK2],					ANA_FORMP, 0x81, P&kom,		E1, FUEHLER, 0},
	...
	{" ->;"," SOL.ANHEB. TH3>"," C    ", P&hks[HK2].SolAnhebTH3,		US_INT, 1, P&hid1,	V0, 0, 0},
	{" ->;"," SOL.ANHEB. TS5>"," C    ", P&hks[HK2].SolAnhebTS5,		US_INT, 1, P&hid1,	V0, 0, 0},
	...
	{"*73:"," NETZ-PUMPE EIN?","       ", P&hkd[HK2].puEinAnz, JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*->:"," BM NETZ-PU EIN?","       ", P&hkd[HK2].puBmAnz,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
	...
	{"*88:"," SM NETZ-PUMPE ?","       ", P&hkd[HK2].puSmAnz,	 JANEIN_FORM, 0, P&vis,		E1, STANDARD, 0},
	...
	{"*98:"," VENTILSTELLUNG "," %     ", P&RVENT[HK2],					AOUT_FORMP, 1, P&vis,		V1, 0, 0},
	...
	{" ->;"," PUMPE REGELART "," 0..3  ", P&BusPuPara[PU_BUS_HK2-1].RegelartHand,	US_CHAR, 0, P&wilo4,	V1, 0, IDX0_FELD},
	{" ->;"," PUMPE SOLLWERT "," %     ", P&hks[HK2].PuDzHand,		  US_INT, 1, P&hid1,	V1, 0, 0},
...
const Parli Pgruppe[] = { 
	...
	{"HKN:", hk2, sizeof(hk2) / PGLENG, P&hk_vis[HK2]},
