...
//	{" ->."," Absenkung Klima"," K     ", P&DTKlima,									US_INT, 1, P&hid2,		V0, 0, 0},
	...
	{"*41;"," S: SOLLWERT    "," C    ", P&maxAnford,					 	 US_INT, 1, P&hid1,	V0, 0, 0},	// nach WP
//	{"*42;"," S: Heizbedarf  ","       ", P&hkdSoL[HK1].heizBed,  JANEIN_FORM, 0, P&hid1,	V0, 0, 0},	// nach WP
	{"*42;"," E: WPU-FREIGABE","       ", P&DM_WPU_Frei,					   JANEIN_FORM, 0, P&hid1,	V0, 0, 0},	// von WP
	{"*43;"," E: WPU BM      ","       ", P&DM_WPU_BM,					   JANEIN_FORM, 0, P&hid1,	V0, 0, 0},	// von WP
	...
	{"*51;"," S: SOLLWERT    "," C    ", P&maxAnford,					 	 US_INT, 1, P&hid1,	V0, 0, 0},	// nach WP
	//{"*52;"," S: Heizbedarf  ","       ", P&hkdSoL[HK1].heizBed,  JANEIN_FORM, 0, P&hid1,	V0, 0, 0},	// nach WP
...
#if HKANZ > 2 // HK1 (Radiatorenheizung)
 {"HK1:", hk3, sizeof(hk3) / PGLENG, P&hk_vis[HK3]},	// ***AnFre
#endif

#if HKANZ > 3 // HK2 (FBH)
 {"HK2:", hk4, sizeof(hk4) / PGLENG, P&hk_vis[HK4]},	// ***AnFre
#endif
...
#if ZE8WM == 1
 {"WN1:", ze5, sizeof(ze5) / PGLENG, P&ze_vis[5]},	// ***AnFre Kessel//SiWa ehemalig WZ1
#endif
//
#if ZE9WM == 1
...
//
#if ZE10WM == 1
 {"WQK:", ze7, sizeof(ze7) / PGLENG, P&ze_vis[7]},	// ***AnFre Netz //ehemalig WZ3
#else
	#if ZE10==1
