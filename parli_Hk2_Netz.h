...
// ***AnFre	{"*->."," Korrektur wwvor"," K     ", P&hkd[HK2].wwvorKorr,			 S_INT, 1, P&hid2,	V0, 0, 0},
	...
	#if LEIBEGR_HK2 == 1
	{"*21:"," ABSENK.LEI.BEGR"," K     ", P&hkd[HK2].leistBegrAbsenk,US_INT,1, P&vis,		V0,	0, 0},
	#endif
...
//	{"*->:"," PUMPENSOLLWERT "," %     ", P&AA_UNI[U3],					AOUT_FORMP, 1, P&vis,		V0, 0, 0},
	{"*->:"," BM PU NK1  EIN?","       ", P&hkd[HK2].puBmAnz,  JANEIN_FORM, 0, P&vis,		V1, 0, 0},
//	{"*->:"," WILO-BUS NETZ-P","       ", P&BusPuPara[PU_BUS_HK2 - 1].Funktion,PU_FUNC_FORM,0, P&vis,	V0, 0, IDX0_FELD},
//	{"*->;"," BUS-ADRESSE    ","       ", P&BusPuPara[PU_BUS_HK2 - 1].Adresse,		 US_CHAR,  0, P&wilo4,V0, 0, IDX0_FELD},
//	{"*->:"," REGELART IST   ","       ", P&BusPuData[PU_BUS_HK2 - 1].regelArtIst,ASCII_FORM,15,P&wilo4,V0,0, IDX0_FELD},
//	{"*->;"," DREHZAHL IST   "," 1/min ", P&modWiloPu[PU_BUS_HK2 - 1].wiloInReg.mwspSpeed.messw, 	US_INT,  0, P&wilo4,V0, 0, IDX0_FELD},
//	{"*->;"," DIFFERENZDRUCK "," mWS   ", P&modWiloPu[PU_BUS_HK2 - 1].wiloInReg.mwspActualDifferentialPressure.messw, 	US_INT,	 1, P&wilo4,V0, 0, IDX0_FELD},
//	{"*->;"," FOERDERSTROM   "," m/h  ", P&modWiloPu[PU_BUS_HK2 - 1].wiloInReg.mwspFlowRate.messw, 	US_INT,	 1, P&wilo4,V0, 0, IDX0_FELD},
