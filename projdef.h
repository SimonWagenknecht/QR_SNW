...
#define ANALOG_AE		6							// Skalierung der 0-10V Eingänge, Grenzwertüberwachung, Anzahl 0..8, immer die ersten n AE_UNI ab AE_UNI1 werden skaliert
#define WRE100			0							// WRE100 Kommandos für WRELES uund WREINIT werden unterstützt
#define MBUSANZ     3             // Anzahl MBus-Zähler (maximal 8)
...
#define IMPLEMENT_S3			(GBUS_IMPL + MBUS1_IMPL)		// 
...
#else
#define MODBUS_SIO							1	//Frenzel Wilo knallt sonst

#define MODBUS_UNI	1            //Frenzel Wilo knallt sonst
#define MODBUS_EXT    0
  #define WILO_MODBUS          1	//Frenzel Wilo knallt sonst
...
//--------------------------------------------------------------------------
  ...
  #define BUS_PU_MAX   4  // Pumpenanzahl gemäß Projektspezifkationen setzen!
#else	
  #define BUS_PU_MAX   0	// Weil WiloBus von Frenzel
#endif
...
#define HKANZ				4							// projektierte Anzahl von Heizkreisen
#define HKMAX				4							// maximale Anzahl (wegen Speicherzuweisung mindestens 1)
...
#define TRLBEG_HK3	1							// Rücklauftemperaturbegrenzung
...
#define PUBM_HK3		1							// Betriebsmeldung Pumpe
...
#define PULZ_HK3		1							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
#define TRLBEG_HK4	1							// Rücklauftemperaturbegrenzung
...
#define STW_HK4			1							// STW-ALARM
#define PUAL_HK4		0							// Pumpenalarm
#define PUBM_HK4		1							// Betriebsmeldung Pumpe
...
#define PULZ_HK4		1							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
#define ZE8					1	//	"				"		WN1: NHK1	
#define ZE9					1	//  "				"		WSK: Solar
#define ZE10				1	//  "				"		WQK: QK
