...
//	#endif
	...
	{" 10:"," STEIGUNG       ","       ", P&hks[HK4].Anst,					US_INT, 2, P&vis,		V0, 0, 0},
	{" 11:"," NIVEAU         "," C    ", P&hks[HK4].Tvpa,					US_INT, 1, P&vis,		V0, 0, 0},
	{" 12:"," VORLAUF   MAX  "," C    ", P&hks[HK4].Tvma,					US_INT, 1, P&vis,		V0, 0, 0},
	{" 13:"," VORLAUF   MIN  "," C    ", P&hks[HK4].Tvmi,					US_INT, 1, P&vis,		V0, 0, 0},
...
//	#endif
	...
	{"*26:"," ESTRICH-PROGR.?","       ", P&hkd[HK4].estrichProg,JANEIN_FORM, 0, P&vis, 	V0, STANDARD, 0},
	{"*27;"," ESTRICH AKT.TAG","       ", P&hkd[HK4].estrichTag,		 US_CHAR, 0, P&hid1,	V0, 0, 0},
	...
	#if BEDARF_HK4==1
	{" 29:"," VORRANG ZEITABS"," 1=JA  ", P&hks[HK4].VorrangZeitabsenkung, US_CHAR, 0, P&vis,	V0, 0, 0},
	#endif
...
//#####ulsch : Ferienautomatik #####
	#if FER == 1
	{" 42:"," FERIENAUTOMATIK"," JA=1  ", P&hks[HK4].FerienAutom,	 		US_CHAR, 0, P&vis,	V0, 0, 0},
	{" 43:"," FER.ABSENK-WERT"," K     ", P&hks[HK4].FerienAbsenk,		 US_INT, 1, P&vis,	V0, 0, 0},
	...
	{" 53;"," KASKADE-MODUS  ","       ", P&hks[HK4].KaskMode,		 	 US_CHAR, 0, P&hid1,V0, 0, 0},
	#endif

	#if LEIBEGR_HK4 == 1
	{" 55;"," Xp LEIST.-BEGR."," K/%   ", P&hks[HK4].XpLeistBegr,		US_INT, 2, P&hid1,	V0, 0, 0},
	#endif
...
// Freitags-Ventilöffnung
	...
	{" 57;"," HZG-ABSENK-TAGE"," Mo=1..", P&hks[HK4].VentiloeffngTag,	GWOTAG2_FORM, 0, P&hid1,	V0, 0, 0},
	{" 57;"," ABSENKBEGINN   "," h:min ", P&hks[HK4].VentiloeffngBeg,		 ZEIT_FORM, 0, P&hid1,	V0, 0, 0},
	{" 57;"," ABSENKENDE     "," h:min ", P&hks[HK4].VentiloeffngEnd,		 ZEIT_FORM, 0, P&hid1,	V0, 0, 0},
	{" 58;"," ABSENKWERT     "," K     ", P&hks[HK4].VentiloeffngAbs,		 		US_INT, 1, P&hid1,	V0, 0, 0},
	{" 59;"," ABSCHALT-TaGRNZ"," C    ", P&hks[HK4].GrenztempAbschalten,		 S_INT, 1, P&hid1,	V0, 0, 0},
	{"*->;"," absenken vo ?  ","       ", P&hkd[HK4].ventiloeffng,		 JANEIN_FORM, 0, P&hid2,	V0, 0, 0},
	#endif
